...
//        // strategies - high level
        element = wd.findElement(By.linkText("ABOUT")); // old school -high resource consumption
        element = wd.findElement(By.partialLinkText("ABO")); // old school - high resource consumption
        element = wd.findElement(By.id("root"));
        element = wd.findElement(By.className("container"));

//        // cssSelector - low level
//        // by tagName
...
//        element = wd.findElement(By.xpath("//*[contains(@href,'ogi')]"));
    ...
    public void postCondition(){
        ...
        // wd.close(); // not closed additional tabs, only current
        wd.quit();
